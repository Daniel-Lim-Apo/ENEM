...
enem_2021 = pd.read_csv('.\dados\microdados_enem_2021\DADOS\MICRODADOS_ENEM_2021.csv', encoding='iso-8859-1', sep=';')
...
dfDictDataByStateAllCollumns = pd.DataFrame.from_dict(dictDataByStateAllCollumns)
dfDictDataByStateAllCollumns.to_csv (r'.\dados\microdados_enem_2021\DADOS\DadosByUF\Stats\RegistriesByUFAllCollumns.csv', index = False, header=True, line_terminator='\r\n')

dfDictDataByStateRegistries = pd.DataFrame.from_dict(dictDataByStateRegistries)
dfDictDataByStateRegistries.to_csv (r'.\dados\microdados_enem_2021\DADOS\DadosByUF\Stats\RegistriesByUF.csv', index = False, header=True, line_terminator='\r\n')
